<template>
  <div class="map_control" style="">
    ...
    <a href="#" @click="interaction('info')" class="map_control_btn ico_info" title="Information">Information</a>
  </div>
</template>
...
<style scoped>
.map_control {width:98px;border:1px solid #65686f; border-radius: 3px; padding:0 3px; margin-right: 3px; height:30px; background-color: #fff; overflow: hidden; display: inline-block;}
